...
const problems = [
  {
    painKey: "lp2.probPain1",
    solutionKey: "lp2.probSolution1",
    icon: (
  ...
  {
    painKey: "lp2.probPain2",
    solutionKey: "lp2.probSolution2",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  {
    painKey: "lp2.probPain3",
    solutionKey: "lp2.probSolution3",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
