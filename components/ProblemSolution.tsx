...
const problems = [
  {
    pain: "Manual entry is homework nobody wants to do",
    solution:
      "Scan a receipt in 2 seconds. AI reads amount, date, merchant, items — in any language.",
    icon: (
  ...
  {
    pain: "I don't want to give my bank credentials to an app",
    solution:
      "Lumi never asks for bank access. Your data stays on your device.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  {
    pain: "I travel — my budget app only works in USD",
    solution:
      "Track expenses in dollars, euros, yen — any currency. Auto-conversion at real rates.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
